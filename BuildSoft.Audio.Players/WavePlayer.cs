...
{
	public class WavePlayer : SoundPlayer, IDisposable
	{
		private static ulong objCnt = 0;
		private static readonly string BaseAlias = "waveplayer";
		...
		public WavePlayer(string path) : this(path, BaseAlias + objCnt)
		{

		}

		public WavePlayer(string path, string alias) : base(path, alias)
		{
		...
		public override void Load()
		{
			...
			string cmd = $@"open ""{FileUri.LocalPath}"" type waveaudio alias {_aliasName}";
